      ...
      <el-table :data="tableData" v-loading="loading" style="width: 100%">
        ...
        <el-table-column label="操作" fixed="right" width="250">
          <template #default="{ row }">
            ...
            <el-button type="warning" link v-if="showStatusEdit" @click="handleStatusEdit(row)">
...
const pageConfig = {
  '/scenic': { title: '景点管理', name: '景点', api: '/admin/scenics', showName: true, showTitle: false, showDesc: true },
  '/hotel': { title: '酒店管理', name: '酒店', api: '/admin/hotels', showName: true, showTitle: false, showDesc: true },
  '/route': { title: '线路管理', name: '线路', api: '/admin/routes', showName: true, showTitle: false, showDesc: true },
  '/booking': { title: '预订管理', name: '预订', api: '/admin/bookings', showName: false, showTitle: false, showHotel: true, showContact: true, showPrice: true, showStatusEdit: true },
  '/itinerary': { title: '行程管理', name: '行程', api: '/admin/itineraries', showName: false, showTitle: true, showDesc: false },
  '/daily-recommend': { title: '每日推荐管理', name: '推荐', api: '/admin/daily-recommendations', showName: false, showTitle: true, showDesc: true },
  '/hotel-stat': { title: '酒店统计管理', name: '统计', api: '/admin/hotel-stats', showName: false, showHotel: true, showPrice: true, showStatusForm: false }
}

const currentConfig = pageConfig[routePath] || pageConfig['/route']
...
const formRules = {
  name: [{ required: currentConfig.showName, message: '请输入名称', trigger: 'blur' }],
...
const showStatusEdit = computed(() => currentConfig.showStatusEdit)
