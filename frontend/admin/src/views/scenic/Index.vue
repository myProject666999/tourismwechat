      ...
      <el-form :inline="true" :model="searchForm" class="search-form">
        ...
        <el-form-item label="状态" v-if="showStatusFilter">
          <el-select v-model="searchForm.status" placeholder="全部" clearable @change="handleSearch">
            <el-option label="正常/上架" :value="1" />
            <el-option label="禁用/下架" :value="0" />
          </el-select>
        </el-form-item>
        <el-form-item>
...
const currentConfig = pageConfig[routePath] || pageConfig['/scenic']
...
const showStatusFilter = computed(() => currentConfig.showStatusFilter)
